...
am__v_CXXLD_1 = 
SOURCES = $(readgmsh_SOURCES)
DIST_SOURCES = $(readgmsh_SOURCES)
...
readgmsh$(EXEEXT): $(readgmsh_OBJECTS) $(readgmsh_DEPENDENCIES) $(EXTRA_readgmsh_DEPENDENCIES) 
	@rm -f readgmsh$(EXEEXT)
	$(AM_V_CXXLD)$(CXXLINK) $(readgmsh_OBJECTS) $(readgmsh_LDADD) $(LIBS)
